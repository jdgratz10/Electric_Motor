...
class Gearbox_Weight(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("var_speed", units = "rpm", desc = "Motor speed")
    ...
    def compute(self, inputs, outputs):
        ...
        outputs["wt"] = K_gearbox * HP_out**.76 * var_speed**.13 / R_RPM**.89 
    ...
    def compute_partials(self, inputs, J):
        ...
        J["wt", "var_speed"] = K_gearbox * HP_out**.76 * .13 / (R_RPM**.89 * var_speed**.87)
